...
public class Api {
    ...
    private ArrayList<Audio> parseAudioList(JSONArray array)
        ...
        return VkAudioImplementation.parseAudioList(array);
    }
    
    private JSONObject sendRequest(Params params) throws JSONException, IOException, KException {
    	 return sendRequest(params, false);
	}
    
    private JSONObject sendRequest(Params params, boolean b) throws JSONException, IOException, KException {
		return vKapi.sendRequest(params,b);
	}
    

    static String unescape(String string) {
		return vKapi.unescape(string);
	}

	public static String unescapeWithSmiles(String string) {
		return vKapi.unescapeWithSmiles(string);
	}
}
